                    ...
                    <div class="card-body">
                        <div class="row  align-items-center justify-content-center text-center h-100">
                            <div class="">
                                ...
                                <button class="btn btn-primary float-left read_more" data-id="<?php echo $row['id'] ?>">Read More</button>
                                <button class="btn btn-primary float-right register-button" data-id="<?php echo $row['id'] ?>">Register</button>
...
<script>
    ...
    $('.register-button').click(function () {
        uni_modal("Submit Registration Request", "registration.php?event_id=" + $(this).attr('data-id'))
    })
</script>